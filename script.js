...
function displayGames(list){
  ...
  list.forEach(game=>{
    ...
    `;
    card.querySelector('.playBtn').addEventListener('click',()=>openGameModal(game.url));
    card.querySelector('.fullscreenBtn').addEventListener('click',()=>openGameFullscreen(game.url));
...
function openGameFullscreen(url){
  ...
  exitBtn.innerText='Salir Fullscreen';
